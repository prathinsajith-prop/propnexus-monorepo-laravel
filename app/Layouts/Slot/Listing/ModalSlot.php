...
class ModalSlot
{
    ...
    public static function createListing(array $options = []): array
    {
        ...
        $formComponent = ListingForm::make('create-listing-form-modal', $config['method'], $config['apiUrl'], $config['masterData']);
        ...
        return DetailSection::make('create-listing-modal')
    ...
    public static function deleteListing(array $options = []): array
    {
        ...
        return DetailSection::make('delete-listing-modal')
            ->setHeader($headerSlot)
            ->setMain(
